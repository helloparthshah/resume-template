...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{\begin{name}Parth\end{name}}{Shah}{ \urlstyle{same}
...
\location{\begin{start_year}2019\end{start_year} - \begin{end_year}2023\end{end_year}}
